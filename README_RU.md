...
Привет! Я **Амаль Абдукулов** — Senior Full-Stack Python Engineer в [SCC](https://scc.uz/) с экспертизой в **Computer Vision**, **AI Security** и **промышленной автоматизации**.

Выпускник **KIUT** (Факультет информационных систем). Специализируюсь на проектировании enterprise-решений, объединяющих возможности AI/ML с производственными системами.

**Основные направления:**
- 🎥 Real-time computer vision конвейеры
- 🛡️ Интеллектуальные системы безопасности
- 🏭 Промышленный IoT и предиктивное обслуживание
- ⚡ Микросервисная архитектура высокого уровня
...
## 📊 Обзор GitHub (точные данные)

<div align="center">

<img src="https://img.shields.io/github/followers/FROWNINGdev?style=for-the-badge&label=Подписчики&color=0EA5E9" alt="Followers" />
<img src="https://img.shields.io/github/stars/FROWNINGdev?style=for-the-badge&label=Звёзды&color=0EA5E9" alt="Stars" />
<img src="https://img.shields.io/github/repo-count/FROWNINGdev?style=for-the-badge&label=Публичные%20репозитории&color=0EA5E9" alt="Public Repos" />

</div>

<div align="center">

<sub>Примечание: внешние карточки со статистикой могут кэшироваться и искажать данные. Эти бейджи читают данные напрямую из GitHub.</sub>
